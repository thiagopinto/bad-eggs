...
CREATE TABLE IF NOT EXISTS "cycle_images_segments" (
    "id" SERIAL NOT NULL PRIMARY KEY,
    "file_name" VARCHAR(255),
    "eggs" INT NOT NULL  DEFAULT 0,
    "bad_eggs" INT NOT NULL  DEFAULT 0,
    "false_positive" BOOL NOT NULL,
    "false_negative" BOOL NOT NULL,
    "imagem_id" INT NOT NULL REFERENCES "cycle_images" ("id") ON DELETE CASCADE
);
